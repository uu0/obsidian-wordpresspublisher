...
export interface WordpressPluginSettings {
  ...
  /**
   * AI service configuration for text and image generation.
   */
  ...
  /**
   * Slug generation mode: 'pinyin' or 'ai-translate'.
   */
  slugGenerationMode: 'pinyin' | 'ai-translate';

  /**
   * Custom prompt template for AI image generation.
   */
  imageGenerationPrompt?: string;

  /**
   * Custom prompt template for AI summary generation.
   */
